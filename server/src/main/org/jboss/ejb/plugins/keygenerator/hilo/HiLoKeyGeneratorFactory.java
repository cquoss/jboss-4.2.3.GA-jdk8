...
{
   static final long serialVersionUID = -8086895827613378739L;
      ...
      throws IOException, ClassNotFoundException
   {
      ...
      dataSource = (ObjectName)getField.get("dataSource", null);
      jndiName = (String)getField.get("jndiName", null);
      tableName = (String)getField.get("tableName", null);
      sequenceColumn = (String)getField.get("sequenceColumn", null);
      sequenceName = (String)getField.get("sequenceName", null);
